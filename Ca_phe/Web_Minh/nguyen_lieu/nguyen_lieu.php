...
<!----------------->
                    <div class="khung_tren">
                        ...
                        <div class="tim_kiem_them">
                            <form method="post">
                                <input type="nhap" style="width: 60%" name="timKiem" placeholder="Nhập tên nguyên liệu">
...
<!----------------->
                    <div class="khung_duoi">
                        <div id="content">
                            ...
                            <label class="chu">Danh mục nguyên liệu:</label>
                            ...
                            <label class="chu">Danh sách nguyên liệu tồn kho:</label>
