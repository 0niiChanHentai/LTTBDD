...
<!----------------->
                    ...
                    <div class="modal" id="eventModal">
                        <div class="modal-content">
                            ...
                            <div class="chu">Thêm sự kiện cho ngày này:</div><br>
                            <input id="eventInput" placeholder="Tên sự kiện" type="text" /><br>
                            <input id="locationInput" placeholder="Địa điểm sự kiện" type="text" /><br>
                            <input id="locationInput" placeholder="Ghi chú sự kiện" type="text" /><br>
