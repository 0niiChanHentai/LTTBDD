        ...
        <div class="noi_dung">
            ...
            <div class="thong_ke">
                ...
                <div class="khung_tren">
                    ...
                    <label class="title">THỐNG KÊ ĐƠN NHẬP NGUYÊN LIỆU</label>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                foreach ($result as $items) :
                                    $dateAndTime = explode(' ', $items['thoigiannhap']); // Assuming 'thoigiannhap' format is 'YYYY-MM-DD HH:MM:SS'
