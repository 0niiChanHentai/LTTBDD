...
<!----------------->
                    <div class="khung_giua">
                        <label class="title">SỬA ĐƠN NHẬP NGUYÊN LIỆU</label>
                    </div>
<!----------------->
                    <div class="khung_duoi">
                        <div id="content">
                            <form method="post" style="display:flex; flex-direction:column;">
                                ...
                                <label class="chu">ID nhập hàng cần sửa thông tin:</label>
                                <?php
                                ...
                                <label class="chu">Thành tiền (Tự động tính toán sau khi nhập số liệu trên bảng):</label>
