...
try {
    ...
    if (!empty($_POST['submit'])) {
        ...
        $sql = "UPDATE san_pham SET tensp='$tensp', giathanh='$giathanh', id_cha='$id_cha', id_danhmuc='$id_danhmuc', thanhphan='$thanhphan', hinhanh='$hinhanh', mota='$mota', phanloai='$phanloai', ghichu='$ghichu' WHERE masp='$masp'";
        $stmt = $conn->prepare($sql);
        $query = $stmt->execute();
